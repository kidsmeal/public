...
You should see a line like `Gantry v0.5.0`. If the command isn't recognized, the plugin didn't load. Run `/reload-plugins` (or restart Claude Code) and try again.
