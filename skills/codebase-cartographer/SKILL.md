...
- **One fact, one home.** Each piece of information lives in exactly one doc; everything else links to it. Duplication is how docs go stale — two copies drift, and the reader can't tell which is current.
